...
df_main = pd.DataFrame(columns=['id', 'name', 'status', 'registered', 'website', 'country', 'entity_type', 'total_budget', 'total_budget', 'parl_meeting', 'comm_meeting', 'recent_parl', 'recent_comm', 'nb_parl_meet', 'nb_comm_meet', 'parl_list', 'comm_list'])
